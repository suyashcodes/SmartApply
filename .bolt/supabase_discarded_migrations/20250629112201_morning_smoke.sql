...
-- 3. Create industry hierarchy table
...
-- 4. Insert industry hierarchy data
...
-- 5. Enable similarity extension
CREATE EXTENSION IF NOT EXISTS pg_trgm;

-- 6. Create skill similarity function
...
-- 7. Create industry similarity function
...
-- 8. Create job title similarity function
...
-- 9. Create distance calculation function
...
BEGIN
  ...
  SELECT array_agg(us.*) INTO user_skills_array
  FROM user_skills us
  ...
  IF total_required_skills > 0 THEN
    ...
    LOOP
      ...
      IF user_skills_array IS NOT NULL THEN
        FOREACH user_skill IN ARRAY user_skills_array
        LOOP
  ...
  IF jsonb_array_length(nice_to_have_skills) > 0 AND user_skills_array IS NOT NULL THEN
